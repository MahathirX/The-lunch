            ...
            <div class="row">
                <div class="col-lg-9">
                            ...
                            <div class="toolbox-info" id="totalProducts">
                                @if (count($getproducts) > 0)
                                    @if (count($getproducts) == 1)
                                        {{ count($getproducts) . ' Product' }}
                                    @else
                                        {{ count($getproducts) . ' Products' }}
                                    @endif
                                @endif
                            </div>
                        </div>
                    ...
                    <div id="dynamicproduct">
                        <div class="products shop_product shop_product_layout3 mb-3 {{ $getproducts ? count($getproducts) > 0 ? '' : 'd-flex justify-content-center' : '' }} 
                                    ...
                                    <div class="filter-items filter-items-count">
                                        @forelse ($categories as $categorie)
                                            <div class="filter-item">
                                                ...
                                                <span class="item-count">{{ count($categorie->products) ?? '0' }}</span>
                                            </div>
                                        @empty
                                ...
                                <div class="widget-body">
                                    <div class="filter-items">
                                        <div class="filter-item">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" name="selectboxbrand[]" id="brand-{{ $brand->id }}" value="{{ $brand->id }}">
                                                <label class="custom-control-label" for="brand-{{ $brand->id }}">{{ $brand->name ?? '' }}</label>
                                            </div>
                                            @empty
                                                <p class="text-danger">No Brand Found !</p>
                                            @endforelse
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget-body">
                                    <div class="filter-items">
                                        <div class="filter-item">
                                            @forelse ($brands as $brand)
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" name="selectboxbrandsmail[]" id="mbrand-{{ $brand->id }}" value="{{ $brand->id }}">
                                                <label class="custom-control-label" for="mbrand-{{ $brand->id }}">{{ $brand->name ?? '' }}</label>
                                            </div>
                                            @empty
                                                <p class="text-danger">No Brand Found !</p>
                                            @endforelse
