...
@endpush
@section('content')
    <div id="cart-view-three" class="page-content">
        <div class="cart">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive cart-view-three-wapper">
                            @if (count($cart) > 0)
                                <table class="table table-cart table-mobile table-border">
                                    <thead>
                                        <tr>
                                            <th width="10%" class="text-center">{{ __f('View Cart Page Table Image Title') }}</th>
                                            <th width="30%" class="text-center">{{ __f('View Cart Page Table Name Title') }}</th>
                                            <th width="10%">{{ __f('View Cart Page Table Price Title') }}</th>
                                ...
                                <div class="cart-view-two-last-wapper mt-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div>
                                                <strong>{{ __f('View Cart Page Delivery Charge Title') }} : </strong><span>
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <a href="{{ route('check.out') }}"
                                                        class="btn checkoutpagecommonbtn">{{ __f('View Cart Page Checkout Title') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
