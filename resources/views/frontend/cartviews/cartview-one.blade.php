...
@endpush
@section('content')
    <div id="cart-view-one" class="page-content">
        <div class="cart">
            <div class="container">
                <div class="heading heading-border mb-1 frontend-product-title text-center mt-2">
                    <h2 class="title">{{ config('settings.cartpagetitle') ?? '' }}</h2>
                </div>
                <div class="row">
                    <div class="col-lg-7">
                        <div class="table-responsive cart-view-one-wapper">
                            @if (count($cart) > 0)
                                <table class="table table-cart table-mobile table-border">
                                    <thead>
                                        <tr>
                                            <th width="30%" class="text-center">{{ __f('View Cart Page Table Name And Image Title') }}</th>
                                            <th width="40%">{{ __f('View Cart Page Table Quntity Title') }}</th>
                                            <th width="30%" class="text-center">{{ __f('View Cart Page Table Total Title') }}</th>
                                        </tr>
                                    </thead>
                    ...
                    <aside class="col-lg-5">
                        <div class="summary summary-cart">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4">
                                <a href="{{ route('index') }}" class="btn checkoutpagecommonbtn">{{ __f('View Cart Page Continue Shopping Title') }}
                                    </a>
