<div class="container dynamiccategorysection position-relative {{ config('settings.productnavbarpositionchosevalue') == 1 ? '' : 'productnavbarpositiontop' }}"">
    ...
    <div class="tab-content tab-content-carousel">
        <div class="tab-pane p-0 fade show active" id="{{ $sections->id }}-new-tab" role="tabpanel" aria-labelledby="{{ $sections->id }}-new-link">
                    ...
                    <div class="product">
                        ...
                        <div class="product-body">
                            <div class="product-cat">
                                <a href="{{ route('categories.show',['slug' =>$sections->slug ]) }}">{{ $sections->name }}</a>
                            </div>
