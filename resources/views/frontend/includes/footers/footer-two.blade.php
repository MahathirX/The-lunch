<footer id="frontend-footer-two" class="footer frontend-footer">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                            @forelse ($footerfour as $footerth)
                                <li><a href="{{ $footerth->url ?? '' }}">{{ $footerth->name ?? '' }}</a></li>
                            @empty
                            @endforelse
                        </ul>
                ...
                <div class="footer-bottom-two d-flex justify-content-between align-items-center">
