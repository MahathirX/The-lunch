...
<body>
    ...
    <script>
        @if (auth()->user()->role_id == 1 || auth()->user()->role_id == 2)
            ...
            var channel = pusher.subscribe('private-adminotification.' + userId);
            channel.bind('notifications', function(data) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var notificationCountOne = document.getElementById('admin_notification_count_one');
                        var notificationCountTwo = document.getElementById('admin_notification_count_two');
                        var getNotifications = document.getElementById('admin_notification');
                        if (data.status == 'success') {
                            notificationCountOne.innerHTML = "";
                            notificationCountTwo.innerHTML = "";
                            getNotifications.innerHTML = "";
                            notificationCountOne.innerHTML = data.notificationCount;
                            notificationCountTwo.innerHTML = data.notificationCount;
