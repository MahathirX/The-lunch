...
<body>
    ...
    <div class="page-wrapper">
        ...
        @if (config('settings.loginpagestyleshowchosevalue') == 1)
            <main class="main d-flex justify-content-center align-items-center">
                @include('auth.registers.register-one')
            </main>
        @elseif(config('settings.loginpagestyleshowchosevalue') == 2)
            <main class="main d-flex justify-content-center align-items-center login-page-two-frontend" style="background-image: url({{ asset(config('settings.login_two_bg_image') ?? '') }})">
                @include('auth.registers.register-two')
            </main>
        @else
            <main class="main d-flex justify-content-center align-items-center login-page-three-frontend" style="background-image: url({{ asset(config('settings.login_page_three_bg_image') ?? 'backend/assets/loginpage/defaultbgimage.jpg') }})">
                @include('auth.registers.register-three')
            </main>
        @endif
        <!-- End .main -->
        <!-- Login Modal Start -->
