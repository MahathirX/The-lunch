...
if (!function_exists('coupontype')) {
    function coupontype($type)
    {
        if ($type == '1') {
            $badgeClass = 'bg-success';
            $badgeTitle = __f('Coupon Flat Title');
        } else {
            $badgeClass = 'bg-dark';
            $badgeTitle = __f('Coupon Percent Title');
        }
        return '<span class="badge badge-sm ' . $badgeClass . ' py-1 px-2">' . $badgeTitle . '</span>';
    }
}
...
if (!function_exists('invoiceStatus')) {
    function invoiceStatus($status)
    {
        if ($status == 1) {
            $badgeClass = 'bg-success';
            $badgeTitle =  __f('Complete Status Title');
        } else {
            $badgeClass = 'bg-warning';
            $badgeTitle = __f('Status Pending Title');
        }
...
if (!function_exists('purchasestatus')) {
    function purchasestatus($status)
    {
        if ($status == 3) {
            $badgeClass = 'bg-success';
            $badgeTitle =  __f('Purchase Status Received Title');
        } else if ($status == 2) {
            $badgeClass = 'bg-danger';
            $badgeTitle =   __f('Purchase Status Pending Title');
        } else if ($status == 1) {
            $badgeClass = 'bg-info';
            $badgeTitle =   __f('Purchase Status Ordered Title');
        } else {
            $badgeClass = 'bg-warning';
            $badgeTitle =   __f('Purchase Status Partial Title');
        }
        return '<span class="badge badge-sm ' . $badgeClass . ' py-1 px-2">' . $badgeTitle . '</span>';
    }
}
...
if (!function_exists('getDealsThreeCarouselOptions')) {
    function getDealsThreeCarouselOptions()
    {
...
if (!function_exists('orderStatusBg')) {
    function orderStatusBg($status)
    {
        if ($status == 1) {
            return 'bg-info';
        } else if ($status == 2) {
...
if (!function_exists('orderstatuswithoutlabel')) {
    function orderstatuswithoutlabel($status)
    {
        if ($status == 1) {
