...
Route::group(['middleware' => ['XSS', 'DEMO']], function () {
    ...
    Route::group(['middleware' => ['HtmlSpecialchars', 'MaintenanceChecker']], function () {
        ...
        Route::controller(HomeController::class)->group(function () {
            ...
            // Route::get('/cars', 'listings')->name('listings');
            // for brand slug for seo
          Route::get('/car', 'listingsbrand')->name('listingsbrand');

        // Route::get('/cars/brands', 'brandpage')->name('brandpage');




            Route::get('/cars/used', 'listingsused')->name('listingsused');

            Route::get('/cars/onlyused', 'onlyused')->name('onlyused');

            Route::get('/car/{slug}', 'listing')->name('listing');

           // Route::get('/brand/{slug}', 'brandlisting')->name('brandlisting');
...
Route::get('/migrate-for-update', function () {
    ...
    $general_setting->app_version = '1.3.0';
