...
<section>
    <div class="card">
        ...
        <div class="card-body">
            <form id="PurchaseCreateForm" action="{{ route('admin.purchase.store') }}" method="POST"
                ...
                <div class="row">
                    <x-form.textbox labelName="{{ __f('Choose Date Label Title') }}" parantClass="col-12 col-md-3" name="invoice_date"
                        ...
                        value="{{ date('Y-m-d') }}" type="date"></x-form.textbox>
                    ...
                    <x-form.selectbox parantClass="col-12 col-md-3" class="form-control py-2" name="status"
                        ...
                        <option value="2">{{ __f('Purchase Status Pending Title') }}</option>
                        <option value="1">{{ __f('Purchase Status Ordered Title') }}</option>
                        <option value="0">{{ __f('Purchase Status Partial Title') }}</option>
                    </x-form.selectbox>
                    <x-form.selectbox parantClass="col-12 col-md-3" class="form-control py-2" name="purchase_type"
                        ...
                        <option value="1">{{ __f('Purchase Supplier Title') }}</option>
