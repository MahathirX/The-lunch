    ...
    <section>
        <div class="card">
            <div class="card-heading">
                <h3 class="p-2">Feature Create Form</h3>
            </div>
            <div class="card-body">
                <form id="featureForm" action="{{ route('admin.feature.store') }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <x-form.textbox labelName="Description" parantClass="col-12 col-md-6" name="description"
                            ...
                            value="{{ old('description') }}"></x-form.textbox>
...
@push('scripts')
    <script>
         $(function() {
            ImagePriviewInsert('first__image', 'picture__first', 'Choose Category Image');
        });
