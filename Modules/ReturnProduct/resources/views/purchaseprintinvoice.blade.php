        ...
        <div class="invoice-container">
            ...
            <div class="section">
                <table class="info-table">
                    ...
                    <tr>
                        <td></td>
                        <td>{{ __f('Created Date Title') }} : {{formatDateByLocale(\Carbon\Carbon::parse($returnPurchaseProduct->create_date)->format('d-m-Y')) ?? '-----' }}</td>
                    </tr>
                </table>
            </div>
                ...
                <tr>
                    ...
                    <th>
                        <div class="total-calculation">
                            ...
                            <p class="d-flex justify-content-between"><span>{{ __f('Total Buy Amount Title') }} :</span> <span> {{ convertToLocaleNumber($returnPurchaseProduct->total_amount + $returnPurchaseProduct->purchasinvoice->admin_sub_total) }}
                                    {{ currency() }}</span></p>
                            <p class="d-flex justify-content-between"><span>{{ __f('Total Due Amount Title') }} :</span> <span> {{ convertToLocaleNumber($returnPurchaseProduct->due_amount ?? 0) }}
                                    {{ currency() }}</span></p>
                            <p class="d-flex justify-content-between"><span>{{ __f('Discount Amount Title') }} : </span> <span> {{ convertToLocaleNumber($returnPurchaseProduct->discount ?? 0) }}
                                    {{ currency() }}</span></p>
