    ...
    <div class="invoice-container">
        ...
        <div class="section">
            <table class="info-table">
                ...
                <tr>
                    <td></td>
                    <td>{{ __f('Created Date Title') }} : {{ $returnProduct->create_date ?? '-----' }}</td>
                </tr>
            </table>
        </div>
                ...
                <th>
                    <div class="total-calculation">
                        <p class="d-flex justify-content-between"><span>{{ __f('Refunded Amount Title') }} :</span> <span>{{ $sub_total }} {{ currency() }}</span> </p>
                            <p class="d-flex justify-content-between"><span>{{ __f('Total Buy Amount Title') }} :</span> <span> {{ $returnProduct->salesinvoice->sub_total ?? 0 }}
                                    {{ currency() }}</span></p>
                            <p class="d-flex justify-content-between"><span>{{ __f('Total Due Amount Title') }}  :</span> <span> {{ $returnProduct->due_amount ?? 0 }}
                                    {{ currency() }}</span></p>
                            <p class="d-flex justify-content-between"><span>{{ __f('Discount Amount Title') }} : </span> <span> {{ $returnProduct->discount ?? 0 }}
                                    {{ currency() }}</span></p>
