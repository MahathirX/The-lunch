...
<section>
    <div class="card">
        <div class="card-heading">
            <h3 class="p-2">{{ __f('Return Product Create Title') }}</h3>
        </div>
        <div class="card-body">
            <form id="returnProductFrom" action="{{ route('admin.returnproduct.store') }}" method="POST"
                        ...
                        <div class="col-12 col-md-4">
                            <div class="" style="flex: 1;">
                                <input class="form-control customer_name" type="text" name="customer_name"
                                    placeholder="{{ __f('Customer Name Title') }}">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="" style="flex: 1;">
                                <input class="form-control customer_address" type="text"
                                    name="customer_address" placeholder="{{ __f('Customer Address Title') }}">
                        ...
                        if (res.status === 'success') {
                            ...
                            setTimeout(() => {
                                @if(Auth::check() && Auth::user()->role_id == 3)
                                    window.location.href = "/staff/returnproduct/" + res.return_product_id;
                                @else
                                    window.location.href = "/admin/returnproduct/" + res.return_product_id;
                                @endif
                            }, 10);
                        }
                    },
        ...
        <tr class="item">
            ...
            $(document).on('keyup', '.item-field', function() {
                ...
                if(invoiceid != null && invoiceid != ''){
                    $.ajax({
                    url: "{{ route('admin.returnproduct.search') }}",
                    method: 'GET',
                    data: {
                        text: value,
                        invoiceid: invoiceid,
            ...
            $('.search_invoices_number').on('keyup', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.returnproduct.invoice.search') }}",
                    data: {
                        invoiceno: invoiceno,
                    },
                    success: function(res) {
