...
@section('add_button')
    <div>
        <a href="{{ route('admin.producttag.create') }}"
...
<div class="row mt-3">
    <div class="col-md-12">
        <div class="card px-3 py-3">
            ...
            <table id="producttag" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>SL</th>
                        <th>Name</th>
...
@push('scripts')
    <script>
        var tables = $('#producttag').DataTable({
            processing: true,
            serverSide: true,
            order: [],
            bInfo: true,
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('admin.producttag.get.data') }}",
                type: "POST",
                dataType: "JSON",
                data: function(d) {
                    d._token = _token,
