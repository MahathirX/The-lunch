            ...
            <div class="bg-white border-bottom-0 pb-4 d-flex justify-content-between align-items-center flex-row">
                ...
                <div class="email-template-search-bar btn-group d-flex align-items-center">
                    ...
                    <input type="text" id="datatable-search" class="h-100 border w-100 py-2 px-3"
                        placeholder="{{ __f("Sales Search Placeholder") }}">
                </div>
            </div>
            <table id="sales_data_id" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>{{ __f("SL Title") }}</th>
                        <th>{{ __f("Invoice No Title") }}</th>
...
@push('scripts')
    <script>
        ...
        var tables = $('#sales_data_id').DataTable({
            processing: true,
            serverSide: true,
            order: [],
            bInfo: true,
