    ...
    <div class="invoice-container">
        ...
        <div class="section">
            <table class="info-table">
                ...
                <tr>
                    <td></td>
                    <td>{{ __f('Created Date Title') }} : {{ $invoice->create_date }}</td>
                </tr>
                <tr>
                    <td></td>
                    <td>{{ __f('Due Date Title') }} : {{ $invoice->due_date }}</td>
                </tr>
            </table>
        </div>
            ...
            <tr>
                ...
                <th>
                    <div class="total-calculation">
                        <p>{{ __f('Sub Total Title') }} : {{ $sub_total }} {{ currency() }}</p>
                        <p>{{ __f('Discount Title') }} : {{ $invoice->discount ?? 0 }} {{ currency() }}</p>
                        <p>{{ __f('Grand Total Title') }} : {{ $grand_total }} {{ currency() }}</p>
                        <p>{{ __f('Paid Amount Title') }} : {{ $invoice->paid_amount }} {{ currency() }}</p>
                        <p>{{ __f('Due amount Title') }} : {{ $due_amount }} {{ currency() }}</p>
                    </div>
                </th>
            </tr>
        </table>
