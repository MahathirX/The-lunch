                ...
                <form id="productEditForm" action="{{ route('admin.product.update', $product->id) }}" method="POST"
                    ...
                    <div class="row g-4">
                        <div class="col-md-9">
                            ...
                            <div class="row mt-2">
                                <x-form.textarea labelName="{{ __f('Product Location Label Title') }}" class="summernote" parantClass="col-md-12"
                                    id="summernote" name="product_location" required="required" errorName="product_location"
                                    value="{{ $product->product_location  ?? old('product_location') }}"></x-form.textarea>
                            </div>
                            <div class="row mt-2">
                                <x-form.textarea labelName="{{ __f('Product Special Feature Label Title') }}" class="summernote" parantClass="col-md-12"
                                    id="summernote" name="special_feature" errorName="special_feature"
                                    value="{{ $product->special_feature ?? old('special_feature') }}"></x-form.textarea>
                            </div>
                            {{-- <div class="row mt-2">
                                <x-form.textarea labelName="Product Short Description" class="summernote" parantClass="col-md-12"
                                    id="summernote" name="short_description"  errorName="short_description"
                                    value="{{  $product->short_description ?? old('short_description') }}"></x-form.textarea>
                            </div>
                            <div class="row mt-2">
                                <x-form.textarea labelName="Product Special Feature" class="summernote" parantClass="col-md-12"
                                    id="summernote" name="special_feature" errorName="special_feature"
                                    value="{{ $product->special_feature ?? old('special_feature') }}"></x-form.textarea>
                            </div> --}}
                            <div class="row mt-2">
                                <x-form.textbox labelName="{{ __f('Product Price Label Title') }}" parantClass="col-12 col-md-6" name="price"
                                    type="text" required="required" placeholder="{{ __f('Product Price Placeholder') }}" errorName="price"
                                    class="py-2" value="{{ $product->price ?? old('price') }}">
                                </x-form.textbox>

                                <x-form.textbox labelName="{{ __f('Product Discount Price Label Title') }}" parantClass="col-12 col-md-6" type="number"
                                    name="discount_price" placeholder="{{ __f('Product Discount Price Placeholder') }}" errorName="discount_price"
                                    class="py-2" value="{{ $product->discount_price ?? old('discount_price') }}">
                                </x-form.textbox>
                            </div>
                            <div class="row mt-2">
                                <x-form.textbox labelName="{{ __f('Product Stock Qty Label Title') }}" parantClass="col-12 col-md-6" name="product_stock_qty"
                                    ...
                                    class="py-2" value="{{ convertToLocaleNumber($product->product_stock_qty ?? old('product_stock_qty')) }}"
                                   ...
                                   value="{{ $product->product_sku ?? old('product_sku') }}" type="text"> </x-form.textbox>
                            </div>

                            {{-- <div class="row mt-2">
                                @if(isset($product->productattribute) && count($product->productattribute) > 0)
                                <div id="select-container">
                                    @forelse ($product->productattibute as $key => $attibute)
                                        <div class="row select-row">
                                            <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2"
                                                name="colorattributes[]" labelName="Select Color" errorName="colorattributes">
                                                <option value="">Select Color</option>
                                                @isset($colorattributes)
                                                    @forelse ($colorattributes->options as $option)
                                                        <option value="{{ $option->id ?? '' }}" {{ $attibute->color_id ==  $option->id ? 'selected' : ''}}>{{ $option->attribute_option ?? '' }}
                                                        </option>
                                                    @empty
                                                        <option value="" disabled class="text-danger"> Create Attribute and name is
                                                            (Color)</option>
                                                    @endforelse
                                                @else
                                                    <option value="" disabled class="text-danger"> Create Attribute and name is
                                            ...
                                            <x-form.selectbox parantClass="col-12 col-md-5" class="form-control py-2"
                                                name="sizeattributes[]" labelName="Select Size" errorName="sizeattributes">
                                                <option value="">Select Size</option>
                                                @isset($sizeattributes)
                                                    @forelse ($sizeattributes->options as $option)
                                                        <option value="{{ $option->id ?? '' }}" {{ $attibute->size_id ==  $option->id ? 'selected' : ''}}>{{ $option->attribute_option ?? '' }}
                                                        </option>
                                                    @empty
                                                        <option value="" disabled class="text-danger"> Create Attribute and name is
                                                            (Size)</option>
                                            ...
                                            <div class="col-1 col-md-1 mt-4">
                                                ...
                                                @if ($key == 0)
                                                <button type="button" class="btn add-btn" id="attribute-add-btn"><i
                            ...
                            <div id="select-container">
                                <div class="row">
                                    <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2"
                                        ...
                                        @isset($colorattributes)
                                            @forelse ($colorattributes->options as $option)
                                                <option value="{{ $option->id ?? '' }}">{{ $option->attribute_option ?? '' }}
                                                </option>
                                            @empty
                                                <option value="" disabled class="text-danger"> Create Attribute and name is
                                                    (Color)
                                            ...
                                            @endforelse
                                        @else
                                            <option value="" disabled class="text-danger"> Create Attribute and name is (Color)
                                            </option>
                                        @endisset
                                    </x-form.selectbox>
                                    <x-form.selectbox parantClass="col-12 col-md-5" class="form-control py-2"
                                        ...
                                        @isset($sizeattributes)
                                            ...
                                            @endforelse
                                        @else
                                            <option value="" disabled class="text-danger"> Create Attribute and name is (Size)
                                            </option>
                                        @endisset
                                    </x-form.selectbox>
                                    <div class="col-1 col-md-1 mt-4">
                                    ...
                                    <div class="upload__box">
                                        ...
                                        <div class="upload__btn-box mb-3">
                                            <label class="upload__btn">
                                                ...
                                                <input type="file" multiple name="product_gallery[]" data-max_length="20"
                                            ...
                                            @isset($imageGallery)
                                                @forelse ($imageGallery as $image)
                                                    <div class="position-relative shadow-lg"
                                                        ...
                                                        <img src="{{ asset($image->image_path) }}" width="100px" height="100px"
                        ...
                        <div class="col-md-3">
                            <div class="row mt-2">
                                <x-form.selectbox parantClass="col-12 col-md-12" class="form-control py-2" name="brand_id"
                                    labelName="{{ __f('Brand Label Title') }}" errorName="brand_id">
                                        <option value="">{{ __f('Brand Select Box Title') }}</option>
                            ...
                            <div class="row mt-2">
                                <x-form.selectbox parantClass="col-12 col-md-12" class="form-control py-2" name="status"
                                        ...
                                        <option {{ $product->status == '1' ? 'selected' : '' }} value="{{ $product->status }}">
                                            {{ __f("Status Publish Title") }}
                                        </option>
                                        <option {{ $product->status == '0' ? 'selected' : '' }} value="{{ $product->status }}">
                                            {{ __f("Status Pending Title") }}
                                        </option>
                                    </x-form.selectbox>
                            </div>
                            {{-- <div class="row mt-2">
                                <x-form.selectbox parantClass="col-12 col-md-12" class="form-control py-2" name="tag"
                                    required="required" labelName="{{ __f('Product Tag Label Title') }}" errorName="tag">
                                    <option value="">{{ __f("Product Tag Select Box Title") }}</option>
                                    @forelse ($tags as $tag )
                                        <option value="{{ $tag->id ?? '' }}">{{ $tag->tag_name ?? '' }}</option>
                                    @empty
                                        <option value="" disabled class="text-danger">{{ __f("No Tag Found Title") }}</option>
                                    @endforelse
                                </x-form.selectbox>
                            </div> --}}
                            <div class="row mt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <ul class="list-unstyled show-category-list">
                                        ...
                                        @foreach ($categories as $category)
                                            <li>
                                                <input type="checkbox" class="parent-category" id="category_{{ $category->id }}" name="productcategory_id[]" value="{{ $category->id }}" {{ in_array($category->id, $getCategoris->toArray()) ? 'checked' : '' }}>
                                                <label for="category_{{ $category->id }}">{{ $category->name }}</label>
                                                @if ($category->subcategories->count() > 0)
                                                    <ul class="ml-4 list-unstyled-second">
                                                        @foreach ($category->subcategories as $subcategory)
                                                            <li>
                                                                <input type="checkbox" class="subcategory" id="subcategory_{{ $subcategory->id }}" name="productcategory_id[]" value="{{ $subcategory->id }}" data-parent="{{ $category->id }}" {{ in_array($subcategory->id, $getCategoris->toArray()) ? 'checked' : '' }}>
                                                                ...
                                                                @if ($megacategories->count() > 0)
                                                                    <ul class="ml-4 list-unstyled-second">
                                                                        @foreach ($megacategories as $megacategorie)
                                                                            <li>
                                                                                <input type="checkbox" class="megacategorie" id="megacategorie_{{ $megacategorie->id }}" name="productcategory_id[]" value="{{ $megacategorie->id }}" data-parent="{{ $subcategory->id }}" {{ in_array($megacategorie->id, $getCategoris->toArray()) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        {{-- <x-form.textbox labelName="Product Name" parantClass="col-12 col-md-6" name="name"
                            required="required" placeholder="Enter Product Name..!" errorName="name" class="py-2"
                            value="{!! $product->name ?? old('name')   !!}"></x-form.textbox> --}}

                        {{-- <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="productcategory_id"
                            required="required" labelName="Product Category Name" errorName="project_id">
                            <option value="">Select Category</option>
                            @foreach ($categories as $category)
                                <option value="{{ $category->id ?? '' }}"
                                    {{ $product->productcategory_id == $category->id ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        {{-- <x-form.textbox labelName="Product Price" parantClass="col-12 col-md-6" name="price"
                            type="number" required="required" placeholder="Enter  Product price..!" errorName="price"
                            class="py-2" value="{{ old('price') ?? $product->price }}">
                        </x-form.textbox> --}}

                        {{-- <x-form.textbox labelName="Product Discount Price" parantClass="col-12 col-md-6" type="number"
                            name="discount_price" placeholder="Enter  Product Discount price..!" errorName="discount_price"
                            class="py-2" value="{{ old('discount_price') ?? $product->discount_price }}">
                        </x-form.textbox> --}}
                    </div>

                    <div class="row">
                        {{-- <x-form.textbox labelName="Product Stock Qty" parantClass="col-12 col-md-6" name="product_stock_qty"
                            placeholder="Enter Product Stock Qty..!" errorName="product_stock_qty"
                            class="py-2" value="{{ old('product_stock_qty') ?? $product->product_stock_qty }}"
                            type="number" step="1" min="0"> </x-form.textbox>

                        <x-form.textbox labelName="product Sales Qty" parantClass="col-12 col-md-6" name="product_sales_qty"
                             placeholder="Enter Product Sales Qty..!" errorName="product_sales_qty"
                            class="py-2" value="{{ old('product_sales_qty') ?? $product->product_sales_qty }}"
                            type="number" step="1" min="0"> </x-form.textbox> --}}
                    </div>


                    <div class="row">
                        {{-- <x-form.textbox labelName="Product Sku" parantClass="col-12 col-md-6" name="product_sku"
                             placeholder="Enter Product Sku!" errorName="product_sku" class="py-2"
                            value="{{ old('product_sku') ?? $product->product_sku }}" type="text"> </x-form.textbox> --}}

                        {{-- <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="status"
                            required="required" labelName="Product Status" errorName="status">
                            <option {{ $product->status == '1' ? 'selected' : '' }} value="{{ $product->status }}">
                                Publish
                            </option>
                            <option {{ $product->status == '0' ? 'selected' : '' }} value="{{ $product->status }}">
                    ...
                    {{-- <div class="row">
                        <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="tag"
                            required="required" labelName="Product Tag" errorName="tag">
                            <option value="0" {{ $product->tag == '0' ? 'selected' : '' }}>No</option>
                            <option value="1" {{ $product->tag == '1' ? 'selected' : '' }}>Yes</option>
                        </x-form.selectbox>
                    </div> --}}
                    <div class="row">
                        {{-- <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="producttype"
                            required="required" labelName="Product Type" errorName="producttype">
                            <option value="0" {{ $product->producttype == '0' ? 'selected' : '' }}>Single</option>
                            <option value="1" {{ $product->producttype == '1' ? 'selected' : '' }}>Variable</option>
                        </x-form.selectbox>
                        <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="brand_id"
                           labelName="Brand" errorName="brand_id">
                        ...
                        <div class="row">
                            {{-- <div class="col-md-6">
                                <label class="text-dark font-weight-medium required">Product Image</label>
                                <div>
                                    <label class="first__picture" for="first__image" tabIndex="0">
                                        <span class="picture__first"></span>
                                    </label>
                        ...
                        {{-- <div class="row">
                            <x-form.textarea labelName="Product Description" class="summernote" parantClass="col-md-12"
                                id="summernote" name="description" required="required" errorName="description"
                                value="{{  $product->description  ?? old('description') }}"></x-form.textarea>
                        </div>
    ...
    @push('scripts')
        <script>
            ...
            if (productimage != '') {
                ...
                $(function() {
                    ImagePriviewUpdate('first__image', 'picture__first', '{{ __f("Product Image Placeholder") }}', myFData);
                });
            }
        </script>
        <script>
