                ...
                <form id="productCreateForm" action="{{ route('admin.product.store') }}" method="POST"
                    ...
                    <div class="row g-4">
                        <div class="col-md-9">
                            ...
                            <div class="row mt-2">
                                <x-form.textbox labelName="Select Date" parantClass="col-6" name="available_date"
                                    type="date" required="required"></x-form.textbox>

                                <x-form.selectbox parantClass="col-6" class="form-control" name="package_type"
                                    ...
                                    <div id="item-container">
                                        <div class="row item-row mt-2">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" id="item_name_0" name="items[0][item_name]"
                                                    class="form-control" placeholder="Item name">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="qty_0">Quantity</label>
                                                <input type="number" id="qty_0" name="items[0][qty]"
                                                    class="form-control qty" value="1">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="unit_0">Unit</label>
                                                <select id="unit_0" name="items[0][unit]" class="form-control">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="number" id="price_0" name="items[0][price]"
                            ...
                            <div class="row mt-2">
                                <x-form.textbox labelName="{{ __f('Product Stock Qty Label Title') }}"
                                    ...
                                    placeholder="{{ __f('Product Stock Qty Placeholder') }}"
                                    errorName="product_stock_qty" class="py-2" value="{{ old('product_stock_qty') }}"
                                    type="number" step="1" min="0"></x-form.textbox>
                                ...
                                <x-form.textbox labelName="{{ __f('Product Sku Label Title') }}"
                                    ...
                                    class="py-2" value="{{ old('product_sku') }}" type="text"></x-form.textbox>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        <div class="row item-row mt-2">
            <div class="col-md-3">
                <input type="text" name="items[${itemIndex}][item_name]" class="form-control" placeholder="Item name">
            </div>
            <div class="col-md-2">
                <input type="number" name="items[${itemIndex}][qty]" class="form-control qty" value="1">
            </div>
            <div class="col-md-3">
                <select name="items[${itemIndex}][unit]" class="form-control">
                    <option value="pcs">pcs</option>
                    <option value="set">set</option>
                    <option value="pencil">pencil</option>
                </select>
            ...
            <div class="col-md-2">
                <input type="number" name="items[${itemIndex}][price]" class="form-control price" value="0">
            </div>
            <div class="col-md-2">
            ...
            function calculateTotal() {
                ...
                // Auto set Product Price input field
                $("input[name='price']").val(totalPrice);

                // Auto set Product Stock Qty field
                $("input[name='product_stock_qty']").val(totalQty);
            }
        });
    </script>
@endpush
